...
from transformers.models.qwen3.modeling_qwen3 import Qwen3Model, Qwen3DecoderLayer, Cache, FlashAttentionKwargs, Unpack, BaseModelOutputWithPast
from transformers.utils import logging
from transformers.models.qwen3.modeling_qwen3 import DynamicCache
from dataclasses import dataclass
from transformers.models.qwen3.modeling_qwen3 import Qwen3ForCausalLM, CausalLMOutputWithPast
from transformers.models.qwen3.modeling_qwen3 import create_causal_mask, create_sliding_window_causal_mask, TransformersKwargs

logger = logging.get_logger(__name__)

class Qwen3DecoderLayerInject(Qwen3DecoderLayer):
...
class Qwen2ModelInject(Qwen3Model):
    def __init__(self, config):
        super().__init__(config)
        self.layers = nn.ModuleList([Qwen3DecoderLayerInject(config, layer_idx) for layer_idx in range(config.num_hidden_layers)])
...
class QwenCausalInject(Qwen3ForCausalLM):
    def __init__(self, config):
