...
from model.internvl2.modeling_internvl_chat import InternVLChatModel
from utils_global.losses import dice_loss, sigmoid_ce_loss
from typing import Optional, Tuple, Union, List
import math
# from model.injector.QwenRes import QwenCausalInject
from model.injector.InternLM2Res import InternLM2CausalInject

class InternVL2SELF1E(InternVLChatModel):
    def __init__(self, config, **kwargs):
        ...
        self.language_model = InternLM2CausalInject(config.llm_config)
    ...
    def forward(self, 
        ...
        **kwargs):
        ...
        for bs in range(len(input_ids)):
            ...
            curr_image_embeds = curr_image_embeds + curr_adapt_image_embeds
            ...
            if not inference and masks_list is not None and seg_prob.shape[0]:
                ...
                llm_image_embeds = self.combine_decode_proj(llm_image_embeds)
        ...
        loss = self.ce_loss_weight * return_dict.loss + seg_loss        
